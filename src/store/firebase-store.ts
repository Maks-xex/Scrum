...
const firebaseConfig = {
  ...
  databaseURL: "https://scrum-39f93-default-rtdb.europe-west1.firebasedatabase.app",
...
export const writeImageUrl = (img: string, name: string, id: string, query: QueryClient): void => {
